  ...
  var prettyPrint = (function () {
    ...
    (function () {
      ...
      /** Given triples of [style, pattern, context] returns a lexing function,
        ...
        *
        * Context is applied to the last non-whitespace, non-myComment token
        * recognized.
        *
        ...
        if (hc) {
          if (options['cStyleComments']) {
            if (hc > 1) {  // multiline hash comments
              ...
              // Stop C preprocessor declarations at an unclosed open myComment
              shortcutStylePatterns.push(
      ...
      function $prettyPrint(opt_whenDone, opt_root) {
        ...
        function doWork() {
          ...
          for (; k < elements.length && clock['now']() < endTime; k++) {
            ...
            // Look for a preceding myComment like
            // <?prettify lang="..." linenums="..."?>
            var attrs = EMPTY;
            {
              for (var preceder = cs; (preceder = preceder.previousSibling);) {
                var nt = preceder.nodeType;
                // <?foo?> is parsed by HTML 5 to a myComment node (8)
